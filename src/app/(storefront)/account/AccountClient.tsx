...
export function AccountClient() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.parchment, fontFamily: "'Raleway', sans-serif", fontSize: 14, color: T.deep }}>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 200, background: T.ivory, borderBottom: `1px solid ${T.borderLight}`, boxShadow: T.shadowSm }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 24px', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            ...
            <Link href="/orders" style={{ fontSize: 13, color: T.mid, textDecoration: 'none', fontWeight: 500 }}>My Orders</Link>
            <button
              onClick={() => logout('/')}
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 60px', display: 'grid', gridTemplateColumns: '240px 1fr', gap: 24, alignItems: 'flex-start' }}>
